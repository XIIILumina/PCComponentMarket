  <nav class="flex justify-between bg-gradient-to-r from-blue-300 from-10% via-blue-100 via-30% to-blue-300 to-90%  p-3">
    <div>
    <a href="/"><img src="../../public/images/fency2.png" alt="Logo" class=" bg-gradient-to-r from-blue-500 from-20% via-gray-400 via-30% to-sky-200 to-90%  rounded-l px-1 transition duration-500 ease-in-out transform hover:bg-blue-500 hover:scale-110 h-12 w-auto inline block "></a>
    </div>
    <div>
