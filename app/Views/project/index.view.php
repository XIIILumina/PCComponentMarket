...
<div class="container mx-auto mt-8">
    ...
    <form method="POST" class="mb-4">
        <div class="flex items-center">
            <input type="text" value="<?= $_POST["Title"] ?? null?>"  name="Title" placeholder="Project Name" class="px-4 py-2 border border-gray-300 mr-2 rounded-lg">
            <input type="text" value="<?= $_POST["Description"] ?? null?>" name="Description" placeholder="Project Description" class="px-4 py-2 border border-gray-300 mr-2 rounded-lg">
